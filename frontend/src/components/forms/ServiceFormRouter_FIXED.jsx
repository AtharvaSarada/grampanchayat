...
const SERVICE_FORMS = {
  // ID 1
  'birth-certificate': {
    component: () => <ComingSoonForm serviceName="Birth Certificate" />,
  ...
  // ID 7
  'trade-license': {
    component: () => <ComingSoonForm serviceName="Trade License" />,
  ...
  // ID 13
  'health-certificate': {
    component: () => <ComingSoonForm serviceName="Health Certificate" />,
  ...
  // ID 15
  'water-connection': {
    component: () => <ComingSoonForm serviceName="Water Connection" />,
