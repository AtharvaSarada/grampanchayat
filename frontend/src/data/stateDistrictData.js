// Indian States and Districts data for cascading dropdowns
...
export const getStates = () => Object.keys(stateDistrictData).sort();

export const getDistrictsByState = (state) => {
  return stateDistrictData[state] || [];
};

export const validateStateDistrict = (state, district) => {
